      ...
      <div className="profile-details-container">
        ...
        <div>
          <div className="c2">
            ...
            <div className="c1">
              <p className="profile-label">User Name</p>
              <div className="profile-input">
                <p>{profileDetails.name}</p>
              </div>
            </div>
          ...
          <div className="c2">
            ...
            <div className="c1">
              <p className="profile-label">Present Address</p>
              <div className="profile-input">
          ...
          <div className="c2">
            <div className="c1">
              <p className="profile-label">Permanent Address</p>
              <div className="profile-input">
                <p>San Jose, California, USA</p>
              </div>
            </div>
    ...
    return (
      <div className="main-container">
        ...
        <div>
          ...
          <div className="profile-container">{this.onRenderProfile()}</div>
        </div>
      </div>
    )
  }
